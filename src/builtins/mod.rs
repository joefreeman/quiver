...
pub struct BuiltinRegistry {
    /// Function name -> (implementation, param_type, result_type)
    functions: HashMap<&'static str, (BuiltinFn, Type, Type)>,
}
...
impl BuiltinRegistry {
    ...
    pub fn get_signature(&self, function: &str) -> Option<(Type, Type)> {
        self.functions
            .get(function)
            .map(|(_, param_type, result_type)| (param_type.clone(), result_type.clone()))
    }
...
fn create_builtin_registry() -> BuiltinRegistry {
    ...
    // IO functions
    register_builtin!(functions, "print", io::builtin_io_print, Type::Union(vec![Type::Integer, Type::Binary]) => Type::Tuple(TypeId::OK));
    register_builtin!(functions, "println", io::builtin_io_println, Type::Union(vec![Type::Integer, Type::Binary]) => Type::Tuple(TypeId::OK));
